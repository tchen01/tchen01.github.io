...
function tipCreate(){
    ...
    tipSec.outerHTML = "<section class='section' id='tip' ><div class='about'><h3>Click on a card title to read more</h3></div><div class='item'><div class='title toggle hidden' onclick='tipRemove()'>remove</div><div class='content toggle hidden' onclick='tipRemove()'>click here to remove this card</div></div><div class='item'><div class='title toggle hidden'>cookies</div><div class='content toggle hidden'>I use one cookie. (to hide this card in the future)</div></div></section> ";

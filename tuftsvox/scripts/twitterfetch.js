      ...
      while(n < x) {
        ...
        if (parseLinks) {
          if (targetBlank) {
            ...
            op += '<div class="tweettitle"><div class="user">' + strip(authors[n].innerHTML) +
              '</div><span class="timePosted"><a href="https://twitter.com/TuftsVOX/status/' + tids[n] + '">' + times[n].getAttribute('aria-label') + '</a></span></div>';
          }
        op += '<div class="tweet">' + strip(tweets[n].innerHTML) + '</div>';
        
        op += '<div class="interact"><a class="reply" href="https://twitter.com/intent/' +
              'tweet?in_reply_to=' + tids[n] + '" class="twitter_reply_icon"' +
              (targetBlank ? ' target="_blank">' : '>') + '<img alt="Reply" src="tuftsvox/img/twitter/reply.svg"/><img alt="Reply" src="tuftsvox/img/twitter/reply_hover.svg"/></a>' + 
              '<a class="retweet" href="https://twitter.com/intent/retweet?tweet_id=' +
              tids[n] + '" class="twitter_retweet_icon"' +
              (targetBlank ? ' target="_blank">' : '>') + '<img alt="Retweet" src="tuftsvox/img/twitter/retweet.svg"/><img alt="Retweet" src="tuftsvox/img/twitter/retweet_hover.svg"/></a>' +
              '<a class="favorite" href="https://twitter.com/intent/favorite?tweet_id=' +
              tids[n] + '" class="twitter_fav_icon"' +
              (targetBlank ? ' target="_blank">' : '>') + '<img alt="Favorite" src="tuftsvox/img/twitter/favorite.svg"/><img alt="Favorite" src="tuftsvox/img/twitter/favorite_hover.svg"/></a></div>';
